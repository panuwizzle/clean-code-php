...
## สารบัญ  
  ...
  5. [อ็อบเจคและโครงสร้างข้อมูล](#อ็อบเจคและโครงสร้างข้อมูล)
     ...
     * [ให้อ็อบเจคมีองค์ประกอบแบบไพรเวทและโปรเทค](#ให้อ็อบเจคมีองค์ประกอบแบบไพรเวทและโปรเทค)
  6. [คลาส](#คลาส)
     * [
แนะนำให้ใช้การประกอบมากกว่าการสืบทอด (composition over inheritance)](#แนะนำให้ใช้การประกอบมากกว่าการสืบทอด-composition-over-inheritance)
     * [หลีกเลี่ยงฟลูเอนท์ อินเตอร์เฟส](#หลีกเลี่ยงฟลูเอนท์-อินเตอร์เฟส)
